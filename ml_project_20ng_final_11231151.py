...
Train_Data_X , ValidTest_Data_X , Train_Data_Y , ValidTest_Data_Y = train_test_split(Data_frame['Article'] , Data_frame['Category'] , test_size = 0.4)

Valid_Data_X , Test_Data_X , Valid_Data_Y , Test_Data_Y = train_test_split(ValidTest_Data_X , ValidTest_Data_Y , test_size = 0.3)
...
HM_valid_BoW_NB_alph_10 = sns.heatmap(NB_BoW_alph_10_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_BoW_NB_alph_0001 = sns.heatmap(NB_BoW_alph_0001_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_BoW_NB_alph_10 = sns.heatmap(NB_BoW_alph_10_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Naive Bayes / BoW : Alpha = 10')
...
HM_test_BoW_NB_alph_0001 = sns.heatmap(NB_BoW_alph_0001_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Naive Bayes / BoW : Alpha = 0.0001')
...
HM_valid_TFIDF_NB_alph_10 = sns.heatmap(NB_TFIDF_alph_10_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_TFIDF_NB_alph_0001 = sns.heatmap(NB_TFIDF_alph_0001_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_TFIDF_NB_alph_10 = sns.heatmap(NB_TFIDF_alph_10_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Naive Bayes / TFIDF - Alpha = 10')
...
HM_test_TFIDF_NB_alph_0001 = sns.heatmap(NB_TFIDF_alph_0001_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Naive Bayes / TFIDF - Alpha = 0.0001')
...
Pipe_3_Drch_50_NB_0001 = Pipeline([
    ...
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_topics=50, max_iter=15, learning_method='online', learning_offset=50., random_state=0)),
...
Pipe_3_Drch_200_NB_0001 = Pipeline([
    ('1_BoW_fit' , CountVectorizer(analyzer = tokenization)),
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_topics=200, max_iter=15, learning_method='online', learning_offset=50., random_state=0)),
    ('1_NB_alph_1' , MultinomialNB(alpha=0.0001))
])
...
HM_valid_Drch_50_valid = sns.heatmap(NB_Drch_50_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_Drch_200_valid = sns.heatmap(NB_Drch_200_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_Drch_50_NB = sns.heatmap(NB_Drch_50_NB_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_Drch_200_NB = sns.heatmap(NB_Drch_200_NB_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_BoW_RF_30_gn_valid = sns.heatmap(RF_BoW_30_gn_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_BoW_RF_60_ent_valid = sns.heatmap(RF_BoW_60_ent_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_BoW_RF_30_gn_test = sns.heatmap(RF_BoW_30_gn_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest: Est=30 -Gini / BoW')
...
HM_valid_BoW_RF_60_ent_test = sns.heatmap(RF_BoW_60_ent_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest: Est=60 -Entropy / BoW')
...
HM_valid_TFIDF_RF_30_gn_valid = sns.heatmap(RF_TFIDF_30_gn_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_TFIDF_RF_60_ent_valid = sns.heatmap(RF_TFIDF_60_ent_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_TFIDF_RF_30_gn_test = sns.heatmap(RF_TFIDF_30_gn_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest: Est=30 -Gini / TFIDF')
...
HM_valid_TFIDF_RF_60_ent_test = sns.heatmap(RF_TFIDF_60_ent_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest: Est=60 -Entropy / TFIDF')
...
Pipe_6_Drch_1000_RF_60_ent = Pipeline([
    ('1_BoW_fit' , CountVectorizer(analyzer = tokenization)),
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_topics=200, max_iter=10, learning_method='online', learning_offset=50., random_state=0)),
    ('2_RF_model' , RandomForestClassifier(n_estimators=60, criterion='entropy'))
])
...
HM_valid_Drch_50_RF_30_gn_valid = sns.heatmap(RF_Drch_50_30_gn_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_Drch_1000_RF_60_ent_valid = sns.heatmap(RF_Drch_1000_60_ent_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_Drch_50_RF_30_gn_test = sns.heatmap(RF_Drch_50_30_gn_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest:Est=30-Gini/LDA 50 topics')
...
HM_test_Drch_50_RF_60_ent_test = sns.heatmap(RF_Drch_1000_60_ent_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('Random Forest:Est=60-Entropy/LDA 200 topics')
...
HM_valid_SVM_BoW_lin_t4_valid = sns.heatmap(SVM_BoW_lin_t4_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_SVM_BoW_rbf_g0001_t7_valid = sns.heatmap(SVM_BoW_rbf_g0001_t7_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_SVM_BoW_lin_t4_test = sns.heatmap(SVM_BoW_lin_t4_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('SVM - Kernel=linear tol=1 x 10^-4 / BoW')
...
HM_test_SVM_BoW_rbf_g0001_t7_test = sns.heatmap(SVM_BoW_rbf_g0001_t7_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_SVM_TFIDF_lin_t4_valid = sns.heatmap(SVM_TFIDF_lin_t4_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_SVM_TFIDF_lin_t4_test = sns.heatmap(SVM_TFIDF_lin_t4_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('SVM - Kernel=linear tol=1 x 10^-4 / TFIDF')
...
Pipe_9_Drch_50_svm_lin_t4 = Pipeline([
    ('1_BoW_fit' , CountVectorizer(analyzer = tokenization)),
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_components=50, max_iter=15, learning_method='online', learning_offset=50., random_state=0)),
    ('3_svm_model' , svm.SVC(C=1.0, kernel='linear', tol=0.0001))
])
...
Pipe_9_Drch_200_svm_rbf_g100_t7 = Pipeline([
    ('1_BoW_fit' , CountVectorizer(analyzer = tokenization)),
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_components=200, max_iter=15, learning_method='online', learning_offset=50., random_state=0)),
...
Pipe_9_Drch_1000_svm_lin_t4 = Pipeline([
    ('1_BoW_fit' , CountVectorizer(analyzer = tokenization)),
    ('3_Drchl_SpMat' , LatentDirichletAllocation(n_components=500, max_iter=5, learning_method='online', learning_offset=50., random_state=0)),
    ('3_svm_model' , svm.SVC(C=1.0, kernel='linear', tol=0.0001))
])
...
HM_valid_SVM_Drch_50_lin_t4_valid = sns.heatmap(SVM_Drch_50_lin_t4_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_SVM_Drch_200_rbf_g100_t7_valid = sns.heatmap(SVM_Drch_200_rbf_g100_t7_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_SVM_Drch_1000_lin_t4_valid = sns.heatmap(SVM_Drch_1000_lin_t4_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_SVM_Drch_50_lin_t4_test = sns.heatmap(SVM_Drch_50_lin_t4_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('SVM-Ker=linear tol=10^-4 /LDA 50 topics')
...
HM_test_SVM_Drch_200_rbf_g100_t7_test = sns.heatmap(SVM_Drch_200_rbf_g100_t7_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('SVM-Ker=rbf gam=100 tol=10^-7/LDA 200 topics')
...
HM_test_SVM_Drch_1000_lin_t4_test = sns.heatmap(SVM_Drch_1000_lin_t4_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('SVM-Ker=linear tol=10^-4/LDA 1000 topics')
...
HM_valid_NN_BoW_10104_valid = sns.heatmap(NN_BoW_10104_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_NN_BoW_20503_valid = sns.heatmap(NN_BoW_20503_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_NN_BoW_10104_test = sns.heatmap(NN_BoW_10104_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(10,10)-LR=10^-4/BoW')
...
HM_test_NN_BoW_20503_test = sns.heatmap(NN_BoW_20503_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(20,50)-LR=10^-3/BoW')
...
HM_valid_NN_TFIDF_10104_valid = sns.heatmap(NN_TFIDF_10104_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_NN_TFIDF_10104_valid = sns.heatmap(NN_TFIDF_20503_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_NN_TFIDF_10104_test = sns.heatmap(NN_TFIDF_10104_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(10,10)-LR=10^-4/TFIDF')
...
HM_test_NN_TFIDF_20503_test = sns.heatmap(NN_TFIDF_20503_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(20,50)-LR=10^-3/TFIDF')
...
HM_valid_NN_Drch_1056_valid = sns.heatmap(NN_Drch_1056_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_valid_NN_Drch_20503_valid = sns.heatmap(NN_Drch_20503_valid_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
...
HM_test_NN_Drch_1056_test = sns.heatmap(NN_Drch_1056_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(10,5)-LR=10^-6/LDA 200')
...
HM_test_NN_Drch_20503_test = sns.heatmap(NN_Drch_20503_test_ConfMat , annot=False , cmap='coolwarm', linecolor='black', linewidth=2)
plt.title('NNs-hidden layer=(20,50)-LR=10^-3/LDA 500')
